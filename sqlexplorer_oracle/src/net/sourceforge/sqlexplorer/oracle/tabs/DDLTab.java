...
public class DDLTab extends AbstractSourceTab {
    ...
    public String getSource() {
        ...
        try {
            ...
            SQLExplorerPlugin.error("Couldn't load ddl for: " + getNode().getName(), e);
    ...
    public String getLabelText() {
        return Messages.getString("oracle.dbdetail.tab.ddl");
    }

    public String getStatusMessage() {
        return Messages.getString("oracle.dbdetail.tab.ddlFor") + " " + getNode().getQualifiedName();
    }
