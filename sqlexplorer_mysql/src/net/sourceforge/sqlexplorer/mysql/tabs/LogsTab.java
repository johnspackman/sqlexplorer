...
public class LogsTab extends AbstractSQLTab {
    ...
    public String getLabelText() {
        ...
        return Messages.getString("mysql.DatabaseDetailView.Tab.Logs");
    }
    ...
    public String getStatusMessage() {
        ...
        return Messages.getString("mysql.DatabaseDetailView.Tab.Logs.status") + " "
