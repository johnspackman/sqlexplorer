<?php include("common/header.php"); ?>
					...
					result table table widget.  Have a look <a href="http://eclipsesql.cvs.sourceforge.net/eclipsesql/sqlexplorer/src/net/sourceforge/sqlexplorer/dataset/actions/ExportCSVAction.java?revision=1.5&view=markup">here</a> for some sample code on how the export to CSV works.</p>
