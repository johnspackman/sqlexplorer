 ...
 *
 */
public class PostgresQueryParser extends AbstractSyntaxQueryParser {
	 ...
	 */
	public PostgresQueryParser(CharSequence sql, boolean enableStructuredComments) {
	 ...
	 * @param sql
	 */
	public PostgresQueryParser(CharSequence sql, int initialLineNo) {
		super(sql);
	...
	protected AnnotatedQuery newQueryInstance(BackedCharSequence buffer, int lineNo) {
		PostgresQuery query = new PostgresQuery(buffer, lineNo, queryType == null ? QueryType.UNKNOWN : queryType);
