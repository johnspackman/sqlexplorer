...
public interface RequiresNode {
	 ...
	 * it.
	 */
	public String QUERY_REQUIRES_HEAD = "SELECT DISTINCT " +
			"type AS \"${postgresql.hdr.objtype}\",CASE WHEN nspname IS NOT NULL THEN nspname||'.'||refname ELSE refname END AS \"${postgresql.hdr.qname}\"," +
