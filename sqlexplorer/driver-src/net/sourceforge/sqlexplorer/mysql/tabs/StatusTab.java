...
public class StatusTab extends AbstractSQLTab {
    ...
    public String getLabelText() {
        ...
        return Messages.getString("mysql.DatabaseDetailView.Tab.Status");
    }
    ...
    public String getStatusMessage() {
        ...
        return Messages.getString("mysql.DatabaseDetailView.Tab.Status.status") + " "
