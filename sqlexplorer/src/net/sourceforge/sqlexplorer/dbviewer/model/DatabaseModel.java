...
public class DatabaseModel implements IDbModel{
	...
	public String[] getCatalogNames(){
		...
		for(int i=0;i<root.children.size();i++){
			if(root.children.get(i) instanceof CatalogNode)
				ls.add(((CatalogNode)root.children.get(i)).toString());
		}
	...
	public List getCatalogs(){
		...
		for(int i=0;i<root.children.size();i++){
			if(root.children.get(i) instanceof CatalogNode)
				ls.add(((CatalogNode)root.children.get(i)));
		}
		return ls;
	}
	public List getSchemas(){
		ArrayList ls=new ArrayList();
		for(int i=0;i<root.children.size();i++){
			if(root.children.get(i) instanceof SchemaNode)
				ls.add(((SchemaNode)root.children.get(i)));
		}
		return ls;
	}
