...
public class RefreshSchema extends Action {
	...
	public RefreshSchema(SchemaNode totn, TreeViewer tv) {
		this.totn=totn;
		this.tv=tv;
	}
	public void run(){
	...
	public String getText() {
		return Messages.getString("RefreshSchema.Refresh_1"); //$NON-NLS-1$
	}
