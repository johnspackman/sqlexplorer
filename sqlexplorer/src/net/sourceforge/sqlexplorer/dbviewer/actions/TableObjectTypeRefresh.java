...
public class TableObjectTypeRefresh extends Action {
	private ImageDescriptor img=ImageDescriptor.createFromURL(SqlexplorerImages.getRefreshIcon());
	TableObjectTypeNode totn;
	TreeViewer tv;
	public ImageDescriptor getImageDescriptor() {
		return img;
	}
	public TableObjectTypeRefresh(TableObjectTypeNode totn, TreeViewer tv) {
		this.totn=totn;
		this.tv=tv;
	}
	public void run(){
	...
	public String getText() {
		return Messages.getString("TableObjectTypeRefresh.Refresh_1"); //$NON-NLS-1$
	}
