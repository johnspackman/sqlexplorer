...
class CreditsItem{
	CreditsItem(TabItem item,Composite parent){
		...
		"The SQL stuff is based on SquirreL SQL (http://squirrel-sql.sourceforge.net)."+separator+separator+//$NON-NLS-1$
		...
		"- log4j (http://jakarta.apache.org/log4j) Logging API"+separator+separator+//$NON-NLS-1$
		"Johan Compagner (joco01@users.sourceforge.net), Jouneau Luc (ljouneau@yahoo.com) and Stephen Schaub (sschaub@bju.edu) have given precious helps. "+separator+//$NON-NLS-1$
		"Chris Potter (cjp0tter@users.sourceforge.net) has written the Sybase plugin. "+separator+//$NON-NLS-1$
		"Chris Potter (cjp0tter@users.sourceforge.net) and Joao Reis Belo (joaoreisbelo@yahoo.com) have written the Sql Server plugin. "+separator+//$NON-NLS-1$
