...
public abstract class AbstractQueryParser implements QueryParser {
	 ...
	 * @param sql
	 */
	public AbstractQueryParser(CharSequence sql) {
	 ...
	 */
	public AbstractQueryParser(CharSequence sql, boolean enableStructuredComments) {
		super();
	...
	public void parse() throws ParserException {
		 ...
		 * fully tokenizer - reseting tokenizer to null is just to insist that it cannot be used
		 * again by accident.  
		 */
		tokenizer = null;
	}
