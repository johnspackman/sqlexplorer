...
public class SQLPreferencePage extends PreferencePage implements IWorkbenchPreferencePage{
	...
	protected Control createContents(Composite parent) {
		...
		fntGroup.setLayout(new FillLayout());
		...
		colorGroup.setLayout(new FillLayout());
	...
	private Control createPreviewer(Composite parent) {
		...
		//fPreviewViewer= new SQLTextViewer(parent, SWT.V_SCROLL | SWT.H_SCROLL | SWT.BORDER,(IPreferenceStore)fOverlayStore);
