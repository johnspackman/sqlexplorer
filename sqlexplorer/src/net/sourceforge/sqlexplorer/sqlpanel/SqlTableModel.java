...
public class SqlTableModel {
    ...
    private SQLString _sqlStatement;
    ...
    public SqlTableModel(ResultSetReader rs, ResultSetMetaData metaData, int maxRows, SQLConnection conn, String[] ss,
            SQLTableSorter sorter, SQLString sql) throws java.lang.Exception {
        this.sorter = sorter;
        this.ss = ss;
        this.conn = conn;
        this.rs = rs;
    ...
    public void moreRows() throws java.lang.Exception {// Retrieves "limitRows"
                                                        // lines each time
    ...
    public String getPartial() {
        if (!allRetrieved)
            return new String("" + list.size() + "\\?"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    /**
     * Returns the SQL Statement that was used to get the results for this
     * tableModel.
     * 
     * @return SQLStatement SQL query string
     */
    public SQLString getSQLStatement() {
