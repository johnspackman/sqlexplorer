...
public class SqlTableModel {
	...
	public SqlTableModel(ResultSetReader rs,ResultSetMetaData metaData, int maxRows, SQLConnection conn, String[]ss,SQLTableSorter sorter, SQLString sql)throws java.lang.Exception{
		this.sorter=sorter;
		this.ss=ss;
		this.conn=conn;
		this.rs=rs;
