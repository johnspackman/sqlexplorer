        ...
        txtComp.getSite().getShell().getDisplay().asyncExec(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    resultsView.setData(((SqlTableModel[]) rsLis.toArray(new SqlTableModel[rsLis.size()])));
        ...
        try {
            ...
            if (b) {
                ...
                if (rs != null) {
                    ...
                    SqlTableModel md = new SqlTableModel(reader, metaData, maxRows, sessionTreeNode.getConnection(), ss, sorter, new SQLString(
                            sql));
                    lt.endMonitor();
