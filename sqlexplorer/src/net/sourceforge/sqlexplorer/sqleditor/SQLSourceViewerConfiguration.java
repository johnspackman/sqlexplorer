...
public class SQLSourceViewerConfiguration extends SourceViewerConfiguration {
	...
	public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer) {
		...
		reconciler.setDamager(dr, ISQLColorConstants.SQL_MULTILINE_COMMENT);
		reconciler.setRepairer(dr, ISQLColorConstants.SQL_MULTILINE_COMMENT);

		dr= new DefaultDamagerRepairer(getSinglelineCommentScanner());		
		reconciler.setDamager(dr, ISQLColorConstants.SQL_SINGLE_LINE_COMMENT);
		reconciler.setRepairer(dr, ISQLColorConstants.SQL_SINGLE_LINE_COMMENT);
		
		dr= new DefaultDamagerRepairer(getStringScanner());
		reconciler.setDamager(dr, ISQLColorConstants.SQL_STRING);
		reconciler.setRepairer(dr, ISQLColorConstants.SQL_STRING);
	...
	public IContentAssistant getContentAssistant(ISourceViewer sourceViewer) {
			...
			ContentAssistant assistant= new ContentAssistant(){
				public void uninstall(){
					...
					SQLCompletionProcessor p1=(SQLCompletionProcessor)getContentAssistProcessor(ISQLColorConstants.SQL_STRING);
					SQLCompletionProcessor p2=(SQLCompletionProcessor)getContentAssistProcessor(ISQLColorConstants.SQL_SINGLE_LINE_COMMENT);
					p1.dispose();
					p2.dispose();
					super.uninstall();
				}
			...
			assistant.setContentAssistProcessor(processor, ISQLColorConstants.SQL_STRING);
			assistant.setContentAssistProcessor(processor, ISQLColorConstants.SQL_SINGLE_LINE_COMMENT);
