...
public class TableSpaceNode implements IDbModel {
    ...
    private String[] keys = { "Initial Extent", "Next Extent", "Min Extent", "Max Extent", "PCT Increase", "Min ExtLen", "Status", "Contents", "Logging",
    ...
    public TableSpaceNode(TableSpacesNode node, SQLConnection conn, String name) {
        ...
        this.txt = name;
        this.conn = conn;
        q = "select INITIAL_EXTENT, NEXT_EXTENT, MIN_EXTENTS, MAX_EXTENTS, PCT_INCREASE, MIN_EXTLEN, STATUS, CONTENTS, LOGGING, EXTENT_MANAGEMENT, ALLOCATION_TYPE from USER_TABLESPACES where TABLESPACE_NAME='"
                + txt + "'";
        p = "select INITIAL_EXTENT, NEXT_EXTENT, MIN_EXTENTS, MAX_EXTENTS, PCT_INCREASE, MIN_EXTLEN, STATUS, CONTENTS, LOGGING, EXTENT_MANAGEMENT, ALLOCATION_TYPE from DBA_TABLESPACES where TABLESPACE_NAME='"
                + txt + "'";
