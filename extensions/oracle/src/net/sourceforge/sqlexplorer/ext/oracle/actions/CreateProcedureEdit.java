...
public class CreateProcedureEdit extends Action {
	...
	public String getText(){
		return "Create a new Procedure..."; //$NON-NLS-1$
	}
	public void run(){
		String owner=((SchemaNode)(((ProcTypeNode)node).getParent())).toString();
		String separator= System.getProperty("line.separator"); //$NON-NLS-1$
		String txt="CREATE OR REPLACE PROCEDURE "+owner+".<procedure> ("+separator
		...
		ObjectEditor oe=new ObjectEditor(null,store,sessionNode.getDictionary(),txt,"Creating a procedure ",conn,"PROCEDURE",owner,null);
		oe.open();
	}
