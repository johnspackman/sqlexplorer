...
public class SysParamsNode implements IDbModel {
	...
	public Composite getComposite(DetailManager detailManager){
		...
		BusyIndicator.showWhile(display,new Runnable(){
			public void run(){
				...
				String sql="SELECT * FROM v$system_parameter  ORDER BY name" ;
	...
	public SysParamsNode(IDbModel s,String name,SQLConnection conn){
		parent=s;
		txt=name;
		this.conn=conn;
	};
