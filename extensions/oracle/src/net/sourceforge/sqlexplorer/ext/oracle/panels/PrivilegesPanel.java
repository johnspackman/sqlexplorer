...
public class PrivilegesPanel implements IActivablePanel{
	...
	public void activate() {
		...
		activated=true;
		final String sql=
		"select grantor, grantee,privilege, grantable from sys.all_tab_privs "+
	...
	public Control create(SessionTreeNode sessionNode, IDbModel tn, Composite parent) {
		...
		tc.setText("Grantee");
		tc=new TableColumn(tb,SWT.NULL);
		tc.setText("Privilege");
		tc=new TableColumn(tb,SWT.NULL);
		tc.setText("Grantable");	
		return cmp;
	}
}
