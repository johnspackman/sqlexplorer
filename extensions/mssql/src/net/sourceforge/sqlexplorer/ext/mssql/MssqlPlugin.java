...
public class MssqlPlugin extends DefaultSessionPlugin {
    private final static ILogger s_log = LoggerController
            .createLogger(MssqlPlugin.class);
    ...
    private boolean isMssql(SessionTreeNode session) {
        ...
        String dbms = null;
        try {
            dbms = session.getSQLConnection().getSQLMetaData()
    ...
    public IDbModel[] getCatalogAddedTypes(CatalogNode catalogNode,
    ...
    public IAction[] getTypeActionsAdded(SessionTreeNode sessionTreeNode,
            IDbModel node, TreeViewer tv) {
        ArrayList ls = new ArrayList();
    ...
    public IAction[] getAddedActions(SessionTreeNode sessionNode,
            IDbModel node, TreeViewer tv) {
        ArrayList ls = new ArrayList();
    ...
    public IDbModel[] getDbRootAddedTypes(DatabaseNode root,
            SessionTreeNode sessionNode) {
        if (isMssql(sessionNode)) {
